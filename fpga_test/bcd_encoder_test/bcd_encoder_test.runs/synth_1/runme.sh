...
HD_PWD='C:/Users/KANG Jian/Desktop/Verilog_everyday/fpga_test/bcd_encoder_test/bcd_encoder_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_encoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCD_encoder.tcl
